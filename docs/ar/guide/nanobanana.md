...
::: tip دعم Safari
بدءًا من v1.6.0، تعمل ميزة **Image Refinement** مباشرة في Safari، بما في ذلك تنزيل الصور بالحجم الكامل من دون علامة مائية. تستخدم Chrome وEdge وFirefox وSafari الآن المسار المدمج نفسه.
:::
